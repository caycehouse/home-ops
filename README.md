# Template for deploying k8s backed by Flux

Highly opinionated template for deploying a single [Talos](https://talos.dev/) cluster with [Flux](https://toolkit.fluxcd.io/) and [SOPS](https://toolkit.fluxcd.io/guides/mozilla-sops/).

The purpose here is to showcase how you can deploy an entire Kubernetes cluster and show it off to the world using the [GitOps](https://www.weave.works/blog/what-is-gitops-really) tool [Flux](https://toolkit.fluxcd.io/). When completed, your Git repository will be driving the state of your Kubernetes cluster. In addition with the help of [Flux](https://toolkit.fluxcd.io/guides/mozilla-sops/) SOPS integrations you'll be able to commit [Age](https://github.com/FiloSottile/age) encrypted secrets to your public repo.
...
2. Push your changes to git
    ...
    📍 **Verify** all the `*.sops.yaml` and `*.sops.yml` files under the `./kubernetes` folder is **encrypted** with SOPS
