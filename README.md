...
- **Storage & Data Protection**: [OpenEBS](https://github.com/openebs/openebs) ZFS LocalPV provides local persistent volumes, with [kopiur](https://github.com/home-operations/kopiur) handling backups and restores. OpenEBS hostpath is retained only for Kopiur's transient mover cache and scratch space. [spegel](https://github.com/spegel-org/spegel) improves reliability by running a stateless, cluster-local OCI image mirror.
