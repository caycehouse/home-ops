...
```
nomad-pack run miniflux --var message="Hola Mundo!"
```
...
balance the Consul service `miniflux-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the miniflux
  application
